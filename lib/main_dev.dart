  ...
  ItemsModel _buildItemsModel(int index) {
    ...
    return ItemsModel(
      cardStyleMode: CardStyleMode(
        ...
        itemColor:
            isDarkMode ? AppColors.darkItemColor : AppColors.lightItemColor,
        animationShimmerColor:
            isDarkMode ? AppColors.darkShimmerColor : Colors.grey[300]!,
      ),
      loadingImageBuilder: (context, child, loadingProgress) {
        return CustomShimmer(
            isDark: widget.themeNotifier.value == ThemeMode.dark);
      },
