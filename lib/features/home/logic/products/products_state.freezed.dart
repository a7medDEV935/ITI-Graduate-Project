...
abstract class Loading<T> implements ProductsState<T> {
...
class __$$SuccessImplCopyWithImpl<T, $Res>
    extends _$ProductsStateCopyWithImpl<T, $Res, _$SuccessImpl<T>>
...
abstract class Success<T> implements ProductsState<T> {
...
abstract class Error<T> implements ProductsState<T> {
